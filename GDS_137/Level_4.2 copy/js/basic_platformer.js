...
var speedTimer;
	...
	powerSpeed = new GameObject({width:24, height:50, x:platform1.x - 200, y:platform1.y-100, color:"purple"});
...
function animate()
{
	...
	while(platform0.hitTestPoint(player.bottom() + player.left()) && player.vy >=0)
	{
		player.y--;
		player.vy = 0;
		player.x++;
